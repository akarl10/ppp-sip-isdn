...
Without going deep into the rabbithole of ISDN, this application implements only ppp and converts octet-based ppp data from pppd to bitsyncrhonous RFC1618 on the network side
